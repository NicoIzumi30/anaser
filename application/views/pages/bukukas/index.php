		...
		<div class="overflow-x-auto container mx-auto">
			<table class="table-auto min-w-full" id="example">
				...
				<tbody class="bg-white divide-y divide-gray-200 <?php if ($bukukas == null) {
					...
					<?php } ?>
					<tr>
						<td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">PENDAPATAN BULAN KEMARIN </td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
						<td></td>
						<td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">Rp. <?= number_format($total_bulan_lalu) ?></td>
						<td></td>
