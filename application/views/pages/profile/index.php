		...
		<div class="block bg-white border border-gray-200 rounded-md shadow p-3">
			<form action="<?= base_url('profile/update') ?>" method="post">
				<div class="mb-2">
					...
					<input id="regular-form-1" type="text" name="nama" class="form-control" value="<?= $user['nama'] ?>"
						placeholder="Nama Lengkap">
				</div>
				<div class="mb-2">
					<label for="regular-form-2" class="form-label">Email</label>
					<input id="regular-form-2" type="text" name="email" class="form-control" value="<?= $user['email'] ?>"
						placeholder="Email">
				</div>
				<div class="modal-footer">
					<button type="submit"
						class="bg-teal-400 hover:bg-teal-600 text-white font-bold rounded-md py-2 px-4">Simpan</button>
				</div>
			</form>
		</div>
	</div>
		...
		<div class="block bg-white border border-gray-200 rounded-md shadow p-3">
			<form action="<?= base_url('profile/update_password') ?>" method="post">
				<div class="mb-2">
					...
					<input id="regular-form-1" type="password" class="form-control" name="current_password"
						placeholder="Password Saat Ini">
				</div>
				<div class="mb-2">
					<label for="regular-form-1" class="form-label">Password Baru</label>
					<input id="regular-form-1" type="password" class="form-control" name="new_password"
