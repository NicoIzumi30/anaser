										...
										<div class="modal-body">
											<div>
												...
												<input id="regular-form-1" required type="text" name="nama"
													class="form-control" value="<?= $row['nama_kategori'] ?>"
													placeholder="Nama Kategori">
											</div>
										</div>
										<div class="modal-footer">
						...
						<div id="edit_<?= $row['id'] ?>" class="modal" tabindex="-1" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<form action="<?= base_url('kategori/update_penyimpanan/' . $row['id']) ?>"
										method="post">
										<div class="modal-body">
											<div>
												<label for="regular-form-1" class="form-label">Penyimpanan</label>
												<input id="regular-form-1" required type="text" name="penyimpanan"
													class="form-control" value="<?= $row['penyimpanan'] ?>"
													placeholder="Penyimpanan">
											</div>
										</div>
										<div class="modal-footer">
