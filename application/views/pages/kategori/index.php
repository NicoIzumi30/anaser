...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <button class="btn btn-teal shadow-md mr-2" data-tw-toggle="modal" data-tw-target="#add">Tambah Kategori</button>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-2">
                    ...
                    <input id="regular-form-1" type="text" name="nama" class="form-control" placeholder="Nama Kategori">
                </div>
            </div>
        ...
        <table class="table table-report -mt-2">
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    ...
                    <td>
                        <div class="font-medium whitespace-nowrap"><?= $row['nama_kategori']; ?></div>
                    </td>
                    <td class="">
                        <div class="flex justify-center items-center">
                            <a class="btn btn-danger shadow-md mr-2" href="javascript:;" data-tw-toggle="modal" data-tw-target="#delete<?=$row['id']?>"> Hapus</a>
                            <button class="btn btn-teal shadow-md mr-2" data-tw-toggle="modal" data-tw-target="#edit<?=$row['id']?>">Edit</button>
                        </div>
                    </td>
                </tr>
                        ...
                        <div class="modal-content">
                            <div class="modal-body p-0">
                                ...
                                <div class="px-5 pb-8 text-center">
                                    <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-24 mr-1">Batalkan</button>
                                    <a href="<?=base_url('kategori/delete/'.$row['id'])?>" class="btn btn-danger w-24">Hapus</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div>
                    <label for="regular-form-1" class="form-label">Nama Kategori</label>
                    <input id="regular-form-1" type="text" name="nama" class="form-control" value="<?=$row['nama_kategori']?>" placeholder="Nama Kategori">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" data-tw-dismiss="modal" class="btn btn-outline-secondary w-24 mr-1">Batalkan</button>
