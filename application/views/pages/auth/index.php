...
<head>
	...
	<meta name="description" content="Website Anaser Berdikari.">
	<meta name="keywords" content="Website Anaser Berdikari.">
		...
		<div class="block xl:grid grid-cols-2 gap-4">
			...
			<div class="hidden xl:flex flex-col min-h-screen">
				<a href="" class="-intro-x flex items-center pt-5">
					<img alt="Anaser Berdikari" class="w-6" src="<?= base_url('assets/images/logo.svg') ?>">
					<span class="text-white text-lg ml-3"> Anaser Berdikari </span>
				</a>
				<div class="my-auto">
					<img alt="Anaser Berdikari" class="-intro-x w-1/2 -mt-16"
						src="<?= base_url('assets/images/illustration.svg') ?>">
