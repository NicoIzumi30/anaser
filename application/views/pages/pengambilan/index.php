	...
	<div class="relative flex flex-col min-w-0 break-words bg-white border-0 shadow-soft-xl rounded-2xl bg-clip-border">
					...
					<div id="addPengambilan" class="modal" tabindex="-1" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<form action="<?= base_url('pengambilan/add') ?>" method="post"
								...
								<option disabled selected>Pilih Kategori</option>
										...
										<div class="col-span-12">
											...
											<input id="pos-form-2" type="number" disabled class="form-control flex-1 harga" name="harga"
												placeholder="Harga">
										</div>
									</div>
		...
		<div class="overflow-x-auto container mx-auto">
			<table class="table-auto min-w-full" id="example">
				...
				<tbody
					class="bg-white <?php if ($pengambilans == null) {
						echo 'text-center';
